...
<tr><td  align="center">
  ...
  <tr>
    <td class="user_location"> 您现在所在的位置是：出金管理&gt;&gt;代付接口 </td>
  </tr>
  <tr>
                            ...
                            <tr>
                              <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="listclass" style="border-bottom:none">
                                <tr class="">
                                  ...
                                  <td >
                                    <input name="clientNumber" id ="clientNumber" type="text" class="input" value="1001" style="width:150;"><span class="redtext"> * 必填(3位数)</span>                                  </td>
                                </tr>
                                <tr class="">
                                  <td class="noarray" width="140">商户的客户账号</td>
                                  <td >
                                    <input name="userAccount" id ="userAccount" type="text" class="input" value="0" style="width:180;">
                                    <img src="images/action_auditing.gif" width="23" height="17" align="absmiddle"><span class="redtext"> * 必填</span></td>
                                </tr>
                                <tr class="">
                                  <td class="noarray" width="140">商户账单号码</td>
                                  <td >
                                    <input name="clientOrderNumber" id ="clientOrderNumber" type="text" class="input" value="00000000" style="width:180;">
                                    <img src="images/action_auditing.gif" width="23" height="17" align="absmiddle"><span class="redtext"> * 必填</span></td>
                                </tr>
                                <tr class="">
                                  <td class="noarray" width="140">客户银行名称</td>
                                  <td >
                                  <input name="bank" id ="bank" type="text" class="input" value="中国银行" style="width:150;">  
                                  <span class="redtext"> * 必填 Bank</span></td>
                                </tr>
                                <tr class="">
                                  <td class="noarray" width="140">客户开户支行</td>
                                  <td >
                                  <input name="branch" id ="branch" type="text" class="input" value="北京支行" style="width:200;">  
                                  <span class="redtext"> * 必填 Branch</span></td>
                                </tr>
                                <tr class="">
                                  <td class="noarray" width="140">客户收款人银行账号</td>
                                  <td >
                                  <input name="account" id ="account" type="text" class="input" value="6100000000000" style="width:180;">  
                                  <span class="redtext"> * 必填 Account</span></td>
                                </tr>
                               <tr class="">        	
                                  <td class="noarray" width="140">客户收款人账户名</td>           
                                  <td >      	
                                  <input name="name" id ="name" type="text" class="input" value="zhangsan" style="width:150;">   
                                  <span class="redtext"> * 必填 Name</span></td>
                                </tr>
                                <tr class="">        	
                                  <td class="noarray" width="140">商户KEY</td>           
                                  <td >      	
                                  <input name="key" id ="key" type="text" class="input" style="width:150;">   
                                  <span class="redtext"> * 必填 Name</span></td>
                                </tr>
                                <tr class="">	
                                  <td class="noarray" width="140">出金金额</td>
                                  <td >
                                  <input name="amount" id ="amount" type="text" class="input" value="0" style="width:100;">  
                                  <span class="redtext"> * 必填 Amount</span></td> 	
                                </tr>
                                ...
                                <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td height="50" align="center"><input id ="btnSend" name="btnSend" type="button" class="button" value="下一步" onClick="selectSubmit3()"> 
