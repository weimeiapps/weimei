...
<tr><td  align="center">
  ...
  <tr>
    <td class="user_location"> 您现在所在的位置是：异步通知&gt;&gt;异步接口 </td>
  </tr>
  <tr>
                            ...
                            <tr>
                              <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="listclass" style="border-bottom:none">
                                <tr class="">
                                 ...
                                 <tr class="">
                                  <td class="noarray" width="140">客户账号</td>
                                  <td >
                                  <input name="userAccount" id ="userAccount" type="text" class="input" value="0" style="width:180;">  
                                  <span class="redtext"> * 必填</span></td>
                                </tr>
                                <tr class="">
                                  <td class="noarray" width="140">交易单号</td>
                                  <td >
                                    <input name="tranId" id ="tranId" type="text" class="input" value="00000000" style="width:180;">
                                ...
                                <tr class="">
                                  <td class="noarray" width="140">实际到账金额</td>
                                  <td >
                                  <input name="c_amount" id ="c_amount" type="text" class="input" value="0" style="width:150;">  
                                  <span class="redtext"> * 必填</span></td>
                                </tr>
                                <tr class="">
                                  <td class="noarray" width="140">交易状态</td>
                                  <td >
                                  <input name="state" id ="state" type="text" class="input" value="" style="width:200;">  
                                  <span class="redtext"> * 必填 state上款</span></td>
                                </tr>
                               ...
                               <tr class="">        	
                                  ...
                                  <span class="redtext"> * 必填 KEY</span></td>
                                </tr>
